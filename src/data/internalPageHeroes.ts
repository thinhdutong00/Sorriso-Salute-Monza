...
const internalPageHeroes: Record<string, InternalPageHeroContent> = {
  ...
  "/attivita/estetica-del-sorriso/": treatmentHero(
    ...
    "Armonia ed estetica dentale",
    "Il tuo sorriso.",
    "Più luminoso e naturale.",
